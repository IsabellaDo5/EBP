...
def agregar_orden(request,id_mesa):
    if request.method == 'GET':
        ...
        with connection.cursor() as cursor:
                ...
                valores1=(id_mesa,id_cliente[0], idempleado.get('empleado_id'),desc)
